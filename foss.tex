...
\begin{frame}[<+->]
    ...
    \begin{itemize}
        ...
        \item Customizability.
              ...
              \note[item]{%
                      Given how permissive many open source tools are, it's possible (and often expected!
                      ) for you to customize the tool to your own needs.
                  }
...
\begin{frame}
    ...
    \lstinputlisting[caption={Example Python code for statistical visualization}, lastline=11]{stats_example.py}
\end{frame}
...
\begin{frame}{Alert}
    \begin{alertblock}{A test of alerts}
        ALERT
    \end{alertblock}
\end{frame}
