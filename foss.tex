...
\begin{frame}
    ...
    \lstinputlisting[caption={\href{https://seaborn.pydata.org/examples/layered_bivariate_plot.html}{Example Python code} for statistical visualization}]{stats_example.py}
\end{frame}
    ...
    \begin{itemize}
        ...
        \item These tools have specific purposes, but can be chained together to form a powerful workflow.
              ...
              \begin{exampleblock}{Solving a Math Problem}
                  The expanded form of \( (x-3)^5 \) is \dots
              \end{exampleblock}
...
\begin{frame}[<+->]
    ...
    \begin{itemize}
        \item Work or results that depend on computer analysis can be shared using Jupyter Notebooks.
              \note[item]{%
                      Other tools include Quarto and Typst.
                  }
