...
\definecolor{wvwcorange}{cmyk}{0, 0.84, 1, 0}
\definecolor{wvwcgray}{cmyk}{0.05, 0, 0, 0.45}
\definecolor{wvwcblack}{cmyk}{0.4, 0.4, 0.4, 1}
\definecolor{wvwccomp}{HTML}{23C2F0} % complementary to wvwcorange, for links
...
\molochcolors{%
  ...
  alerted text=wvwcorange,
}

\setbeamercolor{section title}{fg=wvwcorange}
...
\titlegraphic{\hfill\includegraphics[width=3.5cm]{W_mountain-eps-converted-to.pdf}}
...
\begin{frame}
    ...
    \lstinputlisting[caption={\textcolor{wvwccomp}{\href{https://seaborn.pydata.org/examples/layered_bivariate_plot.html}{Example Python code}} for statistical visualization}, label=list:data-visualization]{stats_example.py}
  \end{frame}
...
\begin{frame}[<+->]
    ...
    \begin{itemize}
        \item \textcolor{wvwccomp}{\href{https://www.github.com}{GitHub}}
...
\begin{frame}[<+->]
    ...
    \begin{itemize}
        ...
        \item Sharing code and a narrative is often more instructive than just sharing the code itself.
              See: \textcolor{wvwccomp}{\href{https://gwosc.org/tutorials/}{gravity wave notebooks}}.
              \note[item]{%
...
\begin{frame}
    ...
    \begin{alertblock}{Choosing a License}
        To walk you through the process of choosing a license, you can use tools such as \textcolor{wvwccomp}{\href{https://choosealicense.com/}{https://choosealicense.com/}}.
    \end{alertblock}
    }
\end{frame}
